...
// interaction (content-width reporting via ResizeObserver ->
// set_pill_content_width, which drives a real native window resize), and
// two of the pill's three documented pre-rewrite bugs were exactly a
// callback-firing-more-than-once race.
